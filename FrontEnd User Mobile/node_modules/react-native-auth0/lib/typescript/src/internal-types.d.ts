...
export type RawMultifactorChallengeOTPResponse = {
...
export type RawMultifactorChallengeResponse = RawMultifactorChallengeOTPResponse | RawMultifactorChallengeOOBResponse | RawMultifactorChallengeOOBWithBindingResponse;
...
export type Auth0Module = {
    ...
    webAuth: (scheme: string, redirectUri: string, state?: string, nonce?: string, audience?: string, scope?: string, connection?: string, maxAge?: number, organization?: string, invitationUrl?: string, leeway?: number, ephemeralSession?: boolean, safariViewControllerPresentationStyle?: number, additionalParameters?: {
        [key: string]: string;
    }) => Promise<Credentials>;
