...
export type MultifactorChallengeOTPResponse = {
    challengeType: string;
};
export type MultifactorChallengeOOBResponse = MultifactorChallengeOTPResponse & {
    oobCode: string;
};
export type MultifactorChallengeOOBWithBindingResponse = MultifactorChallengeOOBResponse & {
    bindingMethod: string;
};
export type MultifactorChallengeResponse = MultifactorChallengeOTPResponse | MultifactorChallengeOOBResponse | MultifactorChallengeOOBWithBindingResponse;
/**
 ...
 */
export declare enum SafariViewControllerPresentationStyle {
    automatic = -2,
    none = -1,
    fullScreen = 0,
    pageSheet = 1,
