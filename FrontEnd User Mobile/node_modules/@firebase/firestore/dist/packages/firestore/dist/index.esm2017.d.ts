...
declare class __PRIVATE_ExponentialBackoff {
    ...
    Uo(): void;
    cancel(): void;
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ $o(): number;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
declare class __PRIVATE_DatastoreImpl extends __PRIVATE_DatastoreImpl_base {
    ...
    V_: boolean;
    m_(): void;
    /** Invokes the provided RPC with auth and AppCheck tokens. */ Do(e: any, t: any, n: any, r: any): Promise<any>;
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ Mo(e: any, t: any, n: any, r: any, i: any): Promise<any>;
    terminate(): void;
}
/**
 * @license
